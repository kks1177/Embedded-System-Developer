...
ProjectPath            :=C:/Users/user/Documents/proj/work01/work03
...
../build-$(ConfigurationName)/work03/main.c$(ObjectSuffix): main.c ../build-$(ConfigurationName)/work03/main.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/user/Documents/proj/work01/work03/main.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.c$(ObjectSuffix) $(IncludePath)
