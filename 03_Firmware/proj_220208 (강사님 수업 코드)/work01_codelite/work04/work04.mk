...
ProjectPath            :=C:/Users/user/Documents/proj/work01/work04
...
../build-$(ConfigurationName)/work04/main.c$(ObjectSuffix): main.c ../build-$(ConfigurationName)/work04/main.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/user/Documents/proj/work01/work04/main.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.c$(ObjectSuffix) $(IncludePath)
